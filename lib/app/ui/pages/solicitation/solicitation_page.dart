...
class SolicitationPage extends GetView<SolicitationController> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Center(child: Obx(() => ListView(
        children: [
          Row(
            children: [
              LogoImobiliaria(),
            ...
            child: Row(
              ...
              children: [
                ...
                SizedBox(
                  width: 150,
                  child: TextFormField(
                    controller: TextEditingController(text: controller.solicitation.value.address?.state),
            ...
            onPressed: () => Get.dialog(AlertDialog(
              ...
              content: ObxValue((agree)=> Column(
                children: [
                  ...
                  ElevatedButton(onPressed: agree.value?controller.createSolicitation: null, style: ButtonStyle(
