  ...
  Widget build(BuildContext context) {
    return GestureDetector(
        ...
        child: Container(
          ...
          child: Row(
            children: [
              solicitation.status == SolicitationStatus.done ? Tooltip(
                message: 'Concluído',
                child: Done(),
              ) :  SolicitationStatus.processing == solicitation.status?Tooltip(
                message: 'Iniciado',
                child: Processing(),
              ):  Tooltip(
              ...
              Expanded(
                  child: Column(
                    ...
                    children: [
                      Text('${solicitation.customer!.name}' , style: TextStyle(color: Colors.white),),
              ...
              Row(
                  children: [
                    if(solicitation.agency == 'a')
                      Tooltip(
                        message: 'Agência A',
                        child: AgencyALogo(),
                      )
                    else if(solicitation.agency == 'b')
                      Tooltip(
                        message: 'Agência B',
                        child: AgencyBLogo(),
                      )
